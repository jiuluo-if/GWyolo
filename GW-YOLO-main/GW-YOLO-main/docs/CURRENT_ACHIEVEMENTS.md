...
> 截止日期：2026-07-30
> 证据范围：项目相关历史对话回顾、Codex 项目记忆、Git 提交与 PR、仓库文档/测试，
...
| GW5 覆盖修复 | 补齐 `GW240922_142106` 的 H1/L1/V1，图像从 429 增至 432；冻结策略变为 101/104，提升来自数据完整性而非模型 | `docs/PROJECT_MEMORY.md` 第 14 节 |
...
| 端到端烟雾测试 | baseline/P4/P3+P4 各完成 seed0、1 epoch；耗时约 55.51/53.28/73.80 秒，峰值显存约 2.52/2.50/5.44 GiB | `docs/PROJECT_MEMORY.md` 第 18 节 |
...
本表是当前入口；更细的时间线、历史快照、参数和失败经验保存在
`docs/PROJECT_MEMORY.md`。若两者冲突，以后者最新日期章节和可复核产物为准。
